#!/bin/bash
#SBATCH --job-name=sd-noise-binned # Specify a name for your job
#SBATCH --output=output-noise-binned.log       # Specify the output log file
#SBATCH --error=error-noise-binned.log         # Specify the error log file
