...
def main():
    ...
    if args.save_dir is not None:
        ...
        size = (width, height)
        for filename in tqdm(files_list[:7500]):
            ...
            # print(np.linalg.norm(image - hidden_img))
            # print(image)
            ...
            im.save(args.save_dir + '/'+save_name+'_wm.png')

            raw_img = Image.fromarray(np.array(raw_img))
            raw_img.save(args.save_dir + '/'+save_name+'_org.png')
